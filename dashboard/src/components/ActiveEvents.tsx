...
export function ActiveEvents({ onBack, onGoToSession }: ActiveEventsProps) {
  ...
  const sessionMap = new Map<
    string,
    { projectId: string; projectName: string; task: string }
  >();
          ...
          <div className="flex items-center justify-center h-full">
            ...
            >
              ...
              <p className="text-xs mt-1.5 max-w-xs mx-auto">
                Events appear here as Claude Code sessions run. Make sure the
                on-tool-use hook is installed.
              </p>
            </div>
          </div>
        ) : (
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {session && (
                        <button
                          onClick={() =>
                            onGoToSession(session.projectId, event.session_id!)
                          }
