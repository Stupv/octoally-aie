...
export function ActiveTerminals({
    ...
    function updateHeight() {
      if (rows !== "auto") {
        ...
        const height = Math.round(
          (containerHeight - padding - gap * (rows - 1)) / rows,
        );
  ...
  const hiddenSet =
    hiddenSessionIds && hiddenSessionIds.length > 0
      ...
      >
        ...
        <div className="relative ml-auto">
          ...
          >
            ...
            <ChevronDown
              className={`w-3 h-3 transition-transform ${colsOpen ? "rotate-180" : ""}`}
            />
          </button>
          {colsOpen && (
            <>
        ...
        <div className="relative">
          ...
          >
            ...
            <ChevronDown
              className={`w-3 h-3 transition-transform ${rowsOpen ? "rotate-180" : ""}`}
            />
          </button>
          {rowsOpen && (
            <>
              ...
              >
                ...
                {[1, 2, 3, 4, 5, 6].map((n) => (
                  <button
                    ...
                    style={{
                      color:
                        n === rows ? "var(--accent)" : "var(--text-secondary)",
        ...
        {cards.length > 0 && (
          <div className="relative">
            ...
            >
              Jump to
              <ChevronDown
                className={`w-3 h-3 transition-transform ${jumpOpen ? "rotate-180" : ""}`}
              />
            </button>
            {jumpOpen && (
              <>
                ...
                >
                  {cards.map(
                    ({ session, groupLabel, projectId: _projectId }) => (
                      <button
                        key={session.id}
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <span
                    className="text-[10px] truncate min-w-0 ml-auto"
                    style={{ color: "var(--text-secondary)" }}
                  >
                    {session.task || "Terminal"}
                  </span>
                ...
                <div className="flex-1 min-h-0 relative">
                  ...
                  <Terminal
                    ...
                    visible={!expanded}
                    passiveResize={!!expanded || session.task === "Terminal"}
                    hideCursor={session.task !== "Terminal"}
                  />
                </div>
              </div>
            );
        ...
        >
          ...
          >
            ...
            <div className="flex-1 min-h-0">
              <Terminal
                sessionId={expanded.session.id}
                visible={true}
                hideCursor={expanded.session.task !== "Terminal"}
              />
            </div>
          </div>
        </div>
